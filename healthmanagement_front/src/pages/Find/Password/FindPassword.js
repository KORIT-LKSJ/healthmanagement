...
const FindPassword = () => {
    ...
    const findPassword = useQuery(
        ...
        async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:8080/auth/forgot/password`, option);
                setModalData({
                    title: "비밀번호 찾기",
        ...
        <div css={container}>
            ...
            <main css={main}>
                ...
                <div css={inputContainer}>
                    <input css={input} type="text" placeholder="아이디를 입력해 주세요." onChange={onFindUserId} />
